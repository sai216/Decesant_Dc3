...
export const MARKETING_CONFIG = {
  ...
  PORTFOLIO: [
    { id: 'dc-01', name: 'QUANTUM LEDGER', systemType: 'Financial Settlement Rails', clientStage: 'Enterprise', year: '2024', month: 'MARCH', clientPartner: 'FRIZDA_CORP', longDescription: 'HARDENED, HIGH-THROUGHPUT SETTLEMENT PROTOCOL FOR INSTITUTIONAL TREASURY OPERATIONS. BUILT ON MODULAR ARCHITECTURE WITH ZERO-LATENCY GOALS.', bgTexture: PORTFOLIO_IMAGES.QUANTUM_LEDGER, caseStudyUrl: 'https://fundio.vc', techStack: ['UI/UX', 'Settlement', 'Finance'] },
    { id: 'dc-02', name: 'VOX ORCHESTRATOR', systemType: 'Agentic Workflow Engine', clientStage: 'Growth', year: '2024', month: 'FEBRUARY', clientPartner: 'FUNDIO_VC', longDescription: 'AUTONOMOUS COGNITIVE ORCHESTRATION LAYER FOR SUPPLY CHAIN OPTIMIZATION. SYNCHRONIZES LLM-DRIVEN AGENTS WITH LEGACY ERP SYSTEMS TO AUTOMATE COMPLEX DECISION-MAKING LOOPS.', bgTexture: PORTFOLIO_IMAGES.VOX_ORCHESTRATOR, caseStudyUrl: 'https://decensat.com/vox', techStack: ['AI', 'AGENTIC', 'Orchestration'] },
    { id: 'dc-03', name: 'BOTANICAL CMS', systemType: 'Asset Management', clientStage: 'Internal', year: '2023', month: 'NOVEMBER', clientPartner: 'CREATIVE_NODE_V', longDescription: 'INTERNAL CULTURE-FIRST ASSET MANAGEMENT SYSTEM. UTILIZING LOCALIZED EDGE NODES AND SOVEREIGN IDENTITY-LINKED ACCESS CONTROL FOR PRINCIPAL-LEVEL NODES.', bgTexture: PORTFOLIO_IMAGES.BOTANICAL_CMS, caseStudyUrl: 'https://decensat.com/botanical', techStack: ['WEB3', 'Asset Management', 'SRT'] },
    { id: 'dc-04', name: 'NEXUS RESERVE', systemType: 'Liquidity Aggregator', clientStage: 'Enterprise', year: '2024', month: 'JANUARY', clientPartner: 'INSTITUTIONAL_PARTNERS', longDescription: 'INSTITUTIONAL LIQUIDITY LAYER FOR DECENTRALIZED TREASURY MANAGEMENT. FEATURES AUTOMATED YIELD REBALANCING AND RISK MITIGATION PROTOCOLS.', bgTexture: PORTFOLIO_IMAGES.NEXUS_RESERVE, caseStudyUrl: 'https://decensat.com/nexus', techStack: ['DeFi', 'Liquidity', 'Yield'] },
    { id: 'dc-05', name: 'HYPER VAULT', systemType: 'Secure Custody Protocol', clientStage: 'Enterprise', year: '2024', month: 'DECEMBER', clientPartner: 'SECURITY_CONSORTIUM', longDescription: 'ADVANCED ASSET ISOLATION PROTOCOL PROVIDING BIOMETRIC-LINKED HARDWARE SECURITY FOR HIGH-VALUE VENTURE ASSETS.', bgTexture: PORTFOLIO_IMAGES.HYPER_VAULT, caseStudyUrl: 'https://decensat.com/hyper-vault', techStack: ['Security', 'Biometric', 'Custody'] },
    { id: 'dc-06', name: 'NEURAL BRIDGE', systemType: 'AI Data Interop', clientStage: 'Growth', year: '2024', month: 'NOVEMBER', clientPartner: 'TECH_PARTNERS', longDescription: 'DATA BRIDGING BETWEEN LEGACY SYSTEMS AND AGENTIC LLM NODES. ENSURES HIGH-FIDELITY SIGNAL PARITY ACROSS DISPARATE DATABASES.', bgTexture: PORTFOLIO_IMAGES.NEURAL_BRIDGE, caseStudyUrl: 'https://decensat.com/neural-bridge', techStack: ['AI', 'Integration', 'Data'] },
    { id: 'dc-07', name: 'AETHER DEX', systemType: 'Decentralized Exchange', clientStage: 'MVP', year: '2023', month: 'OCTOBER', clientPartner: 'DeFi_COLLECTIVE', longDescription: 'LIQUIDITY OPTIMIZED DEX WITH LOW-SLIPPAGE ROUTING AND INSTITUTIONAL ORDER MATCHING FOR INSTITUTIONAL-SCALE TRADES.', bgTexture: PORTFOLIO_IMAGES.AETHER_DEX, caseStudyUrl: 'https://decensat.com/aether', techStack: ['DeFi', 'Exchange', 'Trading'] },
    { id: 'dc-08', name: 'TITAN MESH', systemType: 'Global Node Infra', clientStage: 'Enterprise', year: '2024', month: 'SEPTEMBER', clientPartner: 'GLOBAL_INFRA', longDescription: 'GEOGRAPHICALLY DISTRIBUTED SERVER CLUSTERS FOR RESILIENT DAPP HOSTING AND DECENTRALIZED CLOUD COMPUTE ORCHESTRATION.', bgTexture: PORTFOLIO_IMAGES.TITAN_MESH, caseStudyUrl: 'https://decensat.com/titan', techStack: ['Infrastructure', 'Distribution', 'Reliability'] },
    { id: 'dc-09', name: 'SOLARIS ERP', systemType: 'Venture Ops System', clientStage: 'Internal', year: '2024', month: 'AUGUST', clientPartner: 'INTERNAL_OPS', longDescription: 'UNIFIED EXECUTION SYSTEM FOR VENTURE MANAGEMENT AND RESOURCE ALLOCATION. OPTIMIZED FOR MULTI-TENANT WORKFLOW TRACKING.', bgTexture: PORTFOLIO_IMAGES.SOLARIS_ERP, caseStudyUrl: 'https://decensat.com/solaris', techStack: ['Operations', 'Enterprise', 'Workflow'] },
    { id: 'dc-10', name: 'ORACLE NODE', systemType: 'Data Feed', clientStage: 'Growth', year: '2024', month: 'JULY', clientPartner: 'DATA_PROVIDERS', longDescription: 'INSTITUTIONAL DATA INGESTION LAYER FOR REAL-TIME MARKET SIGNALS. VERIFIED PROOF OF DELIVERY FOR EXTERNAL DATA CONSUMPTION.', bgTexture: PORTFOLIO_IMAGES.ORACLE_NODE, caseStudyUrl: 'https://decensat.com/oracle', techStack: ['Oracle', 'Data', 'Verification'] }
  ],
